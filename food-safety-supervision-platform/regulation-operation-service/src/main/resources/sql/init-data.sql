...
-- ============================================
-- 1. 检查任务 (对应regulation-service的企业和监管人员)
-- ============================================
INSERT INTO inspection_task (id, task_no, enterprise_id, region_id, task_title, task_desc, priority, status, 
                              created_by, assigned_to, assigned_by, assigned_time, started_time, completed_time, 
                              deadline, deleted)
VALUES 
-- 已完成的检查任务
(1, 'TASK202401001', 1, 3, '美味餐饮日常检查', '对餐饮服务单位进行日常监督检查', 'MEDIUM', 'COMPLETED', 
 2, 4, 2, '2024-01-20 09:00:00', '2024-01-21 10:00:00', '2024-01-21 16:00:00', 
 '2024-01-25 18:00:00', 0),

(2, 'TASK202402001', 2, 4, '鲜果园食品店检查', '对食品销售单位进行检查', 'MEDIUM', 'COMPLETED', 
 2, 5, 2, '2024-02-05 09:00:00', '2024-02-06 10:00:00', '2024-02-06 15:00:00', 
 '2024-02-10 18:00:00', 0),

(3, 'TASK202402002', 4, 3, '快乐小吃店重点检查', '重点监管企业专项检查', 'HIGH', 'COMPLETED', 
 2, 4, 2, '2024-02-15 09:00:00', '2024-02-16 10:00:00', '2024-02-16 17:00:00', 
 '2024-02-20 18:00:00', 0),

(4, 'TASK202403001', 5, 6, '香满楼餐厅复查', '对整改情况进行复查', 'HIGH', 'COMPLETED', 
 3, 7, 3, '2024-03-10 09:00:00', '2024-03-11 10:00:00', '2024-03-11 16:30:00', 
 '2024-03-15 18:00:00', 0),

-- 进行中的检查任务
(5, 'TASK202404001', 3, 5, '健康食品加工厂检查', '对食品生产单位进行检查', 'MEDIUM', 'IN_PROGRESS', 
 3, 6, 3, '2024-04-15 09:00:00', '2024-04-16 10:00:00', NULL, 
 '2024-04-20 18:00:00', 0),

-- 待分配的检查任务
(6, 'TASK202404002', 6, 4, '新鲜蔬菜配送中心初检', '新企业备案后首次检查', 'MEDIUM', 'CREATED', 
...
-- 2. 抽检任务 (对应企业和产品)
-- ============================================
INSERT INTO sampling_task (id, task_no, enterprise_id, product_id, region_id, task_title, task_desc, priority, status, 
                            created_by, assigned_to, assigned_by, assigned_time, completed_time, deadline, deleted)
VALUES 
-- 已完成的抽检任务
(1, 'SAMPLE202401001', 3, 7, 5, '全麦面包抽检', '对烘焙食品进行质量抽检', 'MEDIUM', 'COMPLETED', 
 3, 6, 3, '2024-01-25 09:00:00', '2024-01-26 15:00:00', '2024-01-30 18:00:00', 0),

(2, 'SAMPLE202402001', 2, 4, 4, '新鲜苹果抽检', '对水果进行农药残留检测', 'MEDIUM', 'COMPLETED', 
 2, 5, 2, '2024-02-10 09:00:00', '2024-02-11 14:00:00', '2024-02-15 18:00:00', 0),

(3, 'SAMPLE202403001', 4, 10, 3, '炸鸡腿抽检', '对快餐食品进行微生物检测', 'HIGH', 'COMPLETED', 
 2, 4, 2, '2024-03-05 09:00:00', '2024-03-06 16:00:00', '2024-03-10 18:00:00', 0),

-- 待分配的抽检任务
(4, 'SAMPLE202404001', 5, 13, 6, '麻辣火锅底料抽检', '对火锅底料进行添加剂检测', 'HIGH', 'CREATED', 
 3, NULL, NULL, NULL, NULL, '2024-04-25 18:00:00', 0);

-- ============================================
-- 3. 抽检结果
-- ============================================
INSERT INTO sampling_result (task_id, enterprise_id, product_id, sampled_by, sampled_time, result, conclusion, 
                              disposal_suggestion, public_status, published_time, deleted)
VALUES 
-- 合格的抽检结果
(1, 3, 7, 6, '2024-01-26 10:00:00', 'PASS', 
 '经检验，该批次全麦面包各项指标符合GB 7099-2015《食品安全国家标准 糕点、面包》要求，检验结论为合格。', 
 '继续保持良好的生产规范。', 
 'PUBLISHED', '2024-02-01 09:00:00', 0),

(2, 2, 4, 5, '2024-02-11 10:00:00', 'PASS', 
 '经检验，该批次苹果农药残留检测结果符合GB 2763-2021《食品安全国家标准 食品中农药最大残留限量》要求，检验结论为合格。', 
 '继续加强进货查验。', 
 'PUBLISHED', '2024-02-15 09:00:00', 0),

-- 不合格的抽检结果
(3, 4, 10, 4, '2024-03-06 10:00:00', 'FAIL', 
 '经检验，该批次炸鸡腿菌落总数超标，不符合GB 2726-2016《食品安全国家标准 熟肉制品》要求，检验结论为不合格。', 
 '责令企业立即停止销售该批次产品，查明原因并进行整改，加强食品加工过程卫生控制。', 
...
VALUES 
-- 检查合格的记录
(1, 1, 1, 4, '2024-01-21', 'PASS', NULL, 0),

(2, 2, 2, 5, '2024-02-06', 'PASS', NULL, 0),

-- 检查不合格的记录
(3, 3, 4, 4, '2024-02-16', 'FAIL', 
 '发现以下问题：1. 后厨卫生状况较差，地面有油污；2. 部分食材未按要求分类存放；3. 从业人员未佩戴口罩和手套；4. 消毒记录不完整。', 0),

(4, 4, 5, 7, '2024-03-11', 'FAIL', 
 '发现以下问题：1. 火锅底料存放温度不符合要求；2. 食品留样记录缺失；3. 餐具消毒设施运行不正常。', 0),

-- 进行中的检查（暂无结果）
(5, 5, 3, 6, '2024-04-16', NULL, NULL, 0);
...
(3, '食品加工场所卫生', 'FAIL', '后厨地面有油污，墙面有污渍', 0),
(3, '食品储存条件', 'FAIL', '食材未按要求分类存放，生熟混放', 0),
(3, '从业人员操作规范', 'FAIL', '从业人员未佩戴口罩和手套', 0),
...
(4, '食品储存条件', 'FAIL', '火锅底料存放温度为15℃，应低于10℃', 0),
...
-- 6. 整改任务
-- ============================================
INSERT INTO rectification_task (id, inspection_id, enterprise_id, rectification_desc, progress, status, 
...
(2, 'REVIEW_REWORK', 7, '复核意见：存放温度和留样制度已整改到位，但消毒设施仍未完全修复，要求尽快完成维修并提供验收报告。', 
 NULL, '2024-03-25 14:00:00', 0),
(2, 'ENTERPRISE_SUBMIT', 12, '企业再次提交：消毒设施已维修完成，已通过第三方检测验收。', 
...
('SAMPLING_FAIL_4_10_20240306', 'SAMPLING_FAIL', 
 '{"warningType":"SAMPLING_FAIL","bizType":"SAMPLING","bizId":3,"regionId":3,"ownerRegulatorId":4,"title":"抽检不合格预警","content":"快乐小吃店炸鸡腿抽检不合格，菌落总数超标","sourceService":"regulation-operation-service","dedupKey":"SAMPLING_FAIL_4_10_20240306"}', 
 'SENT', 0, '2024-03-06 16:30:00', 0),

('RECTIFICATION_OVERDUE_1_20240227', 'RECTIFICATION_OVERDUE', 
 '{"warningType":"RECTIFICATION_OVERDUE","bizType":"RECTIFICATION","bizId":1,"regionId":3,"ownerRegulatorId":4,"title":"整改逾期预警","content":"快乐小吃店整改任务即将逾期，请及时跟进","sourceService":"regulation-operation-service","dedupKey":"RECTIFICATION_OVERDUE_1_20240227"}', 
 'SENT', 0, '2024-02-27 09:00:00', 0),

-- 待发送的预警事件
('RECTIFICATION_OVERDUE_2_20240412', 'RECTIFICATION_OVERDUE', 
 '{"warningType":"RECTIFICATION_OVERDUE","bizType":"RECTIFICATION","bizId":2,"regionId":6,"ownerRegulatorId":7,"title":"整改逾期预警","content":"香满楼餐厅整改任务已逾期，请立即处理","sourceService":"regulation-operation-service","dedupKey":"RECTIFICATION_OVERDUE_2_20240412"}', 
