...
-- ============================================
-- 5. 食品企业信息 (对应user-service的企业用户ID: 8-13)
-- ============================================
INSERT INTO food_enterprise (id, user_id, enterprise_name, license_no, credit_code, legal_representative, 
                              region_id, address_id, principal, principal_phone, regulator_name, 
                              status, approval_status, approved_by, approved_time, deleted)
VALUES 
-- 正常企业 (东湖区)
(1, 8, '南昌市美味餐饮有限公司', 'JX360102001', '91360102MA35ABC001', '张三', 
 3, 1, '张企业', '13800000008', '王执法', 
 'NORMAL', 'APPROVED', 2, '2024-01-15 10:00:00', 0),

-- 正常企业 (西湖区)
(2, 9, '南昌市鲜果园食品店', 'JX360103002', '91360103MA35ABC002', '李四', 
 4, 4, '李企业', '13800000009', '赵执法', 
 'NORMAL', 'APPROVED', 2, '2024-01-20 14:30:00', 0),

-- 正常企业 (青云谱区)
(3, 10, '南昌市健康食品加工厂', 'JX360104003', '91360104MA35ABC003', '王五', 
 5, 7, '王企业', '13800000010', '刘执法', 
 'NORMAL', 'APPROVED', 3, '2024-02-01 09:00:00', 0),

-- 重点监管企业 (东湖区 - 因投诉过多)
(4, 11, '南昌市快乐小吃店', 'JX360102004', '91360102MA35ABC004', '赵六', 
 3, 2, '赵企业', '13800000011', '王执法', 
 'KEY', 'APPROVED', 2, '2024-02-10 11:00:00', 0),

-- 重点监管企业 (青山湖区 - 因检查不合格)
(5, 12, '南昌市香满楼餐厅', 'JX360111005', '91360111MA35ABC005', '刘七', 
 6, 9, '刘企业', '13800000012', '陈执法', 
 'KEY', 'APPROVED', 3, '2024-02-15 15:00:00', 0),

-- 待审核企业 (西湖区)
(6, 13, '南昌市新鲜蔬菜配送中心', 'JX360103006', '91360103MA35ABC006', '陈八', 
 4, 5, '陈企业', '13800000013', NULL, 
...
VALUES 
-- 美味餐饮的产品
(1, '红烧肉套餐', '餐饮服务', '标准份', 'ACTIVE', '招牌菜品', 0),
(1, '宫保鸡丁', '餐饮服务', '标准份', 'ACTIVE', '川菜系列', 0),
(1, '西湖醋鱼', '餐饮服务', '标准份', 'ACTIVE', '浙菜系列', 0),

-- 鲜果园的产品
(2, '新鲜苹果', '水果', '500g/袋', 'ACTIVE', '进口红富士', 0),
(2, '香蕉', '水果', '500g/把', 'ACTIVE', '海南香蕉', 0),
(2, '橙子', '水果', '1kg/袋', 'ACTIVE', '赣南脐橙', 0),

-- 健康食品加工厂的产品
(3, '全麦面包', '烘焙食品', '500g/袋', 'ACTIVE', '无添加剂', 0),
(3, '杂粮饼干', '烘焙食品', '300g/盒', 'ACTIVE', '低糖配方', 0),
(3, '燕麦片', '谷物制品', '1kg/袋', 'ACTIVE', '即食型', 0),

-- 快乐小吃店的产品
(4, '炸鸡腿', '快餐', '单份', 'ACTIVE', '现炸现卖', 0),
(4, '汉堡包', '快餐', '单份', 'ACTIVE', '牛肉汉堡', 0),
(4, '薯条', '快餐', '中份', 'ACTIVE', '配番茄酱', 0),

-- 香满楼餐厅的产品
(5, '麻辣火锅', '餐饮服务', '2-4人份', 'ACTIVE', '川渝风味', 0),
(5, '清汤火锅', '餐饮服务', '2-4人份', 'ACTIVE', '养生系列', 0),
(5, '特色凉菜拼盘', '餐饮服务', '标准份', 'ACTIVE', '开胃菜', 0),

-- 新鲜蔬菜配送中心的产品
(6, '有机蔬菜礼盒', '蔬菜', '3kg/盒', 'ACTIVE', '当日采摘', 0),
(6, '时令蔬菜包', '蔬菜', '5kg/包', 'ACTIVE', '家庭装', 0);
...
VALUES 
(4, 'COMPLAINT_OVERFLOW', '近3个月收到5次投诉，超过阈值', 'COMPLAINT', NULL, 2, '2024-03-01 10:00:00');

-- 香满楼餐厅因连续检查不合格被列为重点监管
INSERT INTO enterprise_key_reason (enterprise_id, reason_type, reason_detail, source_type, source_id, operator_id, create_time)
VALUES 
(5, 'CONSECUTIVE_FAIL', '连续2次检查发现问题未整改', 'ROUTINE', NULL, 3, '2024-03-05 14:00:00');
...
('2024年第一季度食品安全抽检结果公示', '抽检公示', 
 '根据《食品安全法》规定，现将2024年第一季度食品安全监督抽检结果予以公示。本次共抽检食品样品200批次，合格195批次，不合格5批次，合格率97.5%。', 
...
('食品安全知识宣传周活动预告', '活动公告', 
 '为提高公众食品安全意识，我局将于5月1日至7日举办食品安全知识宣传周活动，欢迎广大市民参与。', 
