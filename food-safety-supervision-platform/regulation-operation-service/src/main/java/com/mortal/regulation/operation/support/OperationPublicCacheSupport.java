...
import com.mortal.regulation.operation.config.OperationPublicCacheProperties;
...
@Service
public class OperationPublicCacheSupport {

    private static final String LOCK_SUFFIX = ":lock";
    private static final String SCENE = "operation-public-cache";
    ...
    private final OperationPublicCacheProperties operationPublicCacheProperties;
    private final ObjectProvider<RedissonClient> redissonClientProvider;

    public OperationPublicCacheSupport(RedisTemplate<String, Object> redisTemplate,
                                       PlatformRedisSupport platformRedisSupport,
                                       OperationPublicCacheProperties operationPublicCacheProperties,
                                       ObjectProvider<RedissonClient> redissonClientProvider) {
        this.redisTemplate = redisTemplate;
        this.platformRedisSupport = platformRedisSupport;
        this.operationPublicCacheProperties = operationPublicCacheProperties;
        this.redissonClientProvider = redissonClientProvider;
    }

    public <T> T getOrLoadList(String key, Supplier<T> loader) {
        if (!operationPublicCacheProperties.isEnabled()) {
            return loader.get();
        }
        return getOrLoad(key, loader,
            operationPublicCacheProperties.getListTtlSeconds(),
            operationPublicCacheProperties.getLockLeaseSeconds());
    }
    ...
    public <T> T getOrLoadDetail(String key, Supplier<T> loader) {
        ...
        return getOrLoad(key, loader,
            operationPublicCacheProperties.getDetailTtlSeconds(),
            operationPublicCacheProperties.getLockLeaseSeconds());
    }
