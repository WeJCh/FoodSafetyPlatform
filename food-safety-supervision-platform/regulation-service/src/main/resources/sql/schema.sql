...
CREATE TABLE IF NOT EXISTS food_enterprise (
  ...
  regulator_id BIGINT COMMENT '包保责任人ID',
...
CREATE TABLE IF NOT EXISTS food_product (
  ...
  category VARCHAR(50) NOT NULL COMMENT '监管产品品类',
...
CREATE TABLE IF NOT EXISTS enterprise_key_reason (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  enterprise_id BIGINT NOT NULL COMMENT '企业ID',
  reason_type VARCHAR(30) NOT NULL COMMENT 'WARNING_TRIGGERED / COMPLAINT_OVERFLOW / CONSECUTIVE_INSPECTION_FAIL / SAMPLING_FAIL / RECTIFICATION_OVERDUE / MANUAL_SET',
