...
public interface BulletinService {
    ...
    PageResult<BulletinVO> listAdmin(Long userId, String keyword, String status, int page, int size);
    ...
    PageResult<BulletinVO> listPublic(String keyword, int page, int size);
