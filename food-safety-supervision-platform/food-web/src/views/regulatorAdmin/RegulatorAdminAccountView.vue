<template>
  <RegulatorAdminWorkspacePage
    active-key=""
    :username="regulatorUser.username || currentUser.username || ''"
    search-placeholder="搜索企业、任务或监管对象"
            ...
            <div class="hero-profile__body">
              ...
              <div class="hero-profile__meta">
                ...
                <span>
                  ...
                  {{ currentUser.username || regulatorUser.username || "-" }}
                </span>
              </div>
            </div>
          </div>
        ...
        <section class="account-card">
          ...
          <div class="info-panel">
            <div v-if="!editingBasic" class="field-grid">
              ...
              <article class="field-card">
                <span>登录账号</span>
                <strong>{{ currentUser.username || regulatorUser.username || "-" }}</strong>
              </article>
              <article class="field-card">
                <span>账号状态</span>
            ...
            <div v-else class="field-grid">
              ...
              <label class="field">
                <span>登录账号</span>
                <input :value="currentUser.username || regulatorUser.username || '-'" type="text" readonly />
              </label>
              <label class="field">
                <span>账号状态</span>
...
const roleLabel = "区域管理员";
const displayName = computed(() => currentUser.realName || profile.name || regulatorUser.value.username || "监管员");
...
function fillCurrentUser(data) {
  currentUser.username = data?.username || regulatorUser.value.username || "";
