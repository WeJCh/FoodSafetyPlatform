<template>
  <div class="public-sampling-result-detail-page">
      ...
      <div class="public-sampling-result-detail-page__topbar-inner">
        ...
        <div class="public-sampling-result-detail-page__toolbar">
          <label class="public-sampling-result-detail-page__search-box">
            ...
            <input type="text" placeholder="搜索抽检企业..." @keyup.enter="goToListWithSearch" />
          </label>
          <button type="button" class="public-sampling-result-detail-page__icon-btn" @click="onFeaturePending('通知中心')">
            <span class="material-symbols-outlined" aria-hidden="true">notifications</span>
          </button>
          <button type="button" class="public-sampling-result-detail-page__icon-btn" @click="onFeaturePending('个人中心')">
    ...
    <main class="public-sampling-result-detail-page__main">
      ...
      <div v-else-if="!detail" class="status error">抽检结果未找到或已下线</div>
      <template v-else>
        <section class="public-sampling-result-detail-page__hero">
          <div class="public-sampling-result-detail-page__hero-bar">
            ...
            <i
              class="public-sampling-result-detail-page__status-pill"
              :class="detail.result === 'FAIL' ? 'is-risk' : 'is-normal'"
            >
              {{ formatResult(detail.result) }}
            </i>
          </div>
          <h1>{{ detail.productName || "-" }}</h1>
          <p class="public-sampling-result-detail-page__hero-en">抽检结果公示 · Sampling Inspection Result</p>
        ...
        <section class="public-sampling-result-detail-page__content">
          <article class="public-sampling-result-detail-page__article-card">
            ...
            <div
              class="public-sampling-result-detail-page__panel"
              :class="detail.result === 'FAIL' ? 'is-risk' : 'is-pass'"
            >
              <h3>
          ...
          <aside class="public-sampling-result-detail-page__side">
            ...
            <div class="public-sampling-result-detail-page__side-card">
              ...
              <button type="button" @click="onFeaturePending('分享抽检结果')">分享</button>
            </div>
          </aside>
        </section>
      </template>
...
function formatPublicStatus(value) {
  ...
  return publicStatusMap[key] || (value ? String(value) : "-");
}
...
<style scoped>
.public-sampling-result-detail-page {
  min-height: 100vh;
  background: var(--surface);
}

.public-sampling-result-detail-page__topbar {
  position: sticky;
  top: 0;
  z-index: 40;
...
.public-sampling-result-detail-page__topbar-inner {
  max-width: 1680px;
  margin: 0 auto;
...
.public-sampling-result-detail-page__brand-nav {
  display: flex;
  align-items: center;
  gap: 24px;
}

.public-sampling-result-detail-page__brand {
...
.public-sampling-result-detail-page__nav {
  display: flex;
  align-items: center;
  gap: 18px;
}

.public-sampling-result-detail-page__nav-item {
  border: none;
...
.public-sampling-result-detail-page__nav-item.is-active {
  color: var(--primary);
  border-bottom-color: var(--primary);
}

.public-sampling-result-detail-page__toolbar {
  display: flex;
  align-items: center;
  gap: 10px;
}

.public-sampling-result-detail-page__search-box {
  display: inline-flex;
  align-items: center;
  gap: 6px;
  border-radius: 8px;
...
.public-sampling-result-detail-page__search-box input {
  border: none;
  background: transparent;
...
.public-sampling-result-detail-page__icon-btn {
...
.public-sampling-result-detail-page__logout {
  min-height: var(--public-toolbar-min-h);
  font-size: var(--public-logout-font-size);
  margin: 0;
}

.public-sampling-result-detail-page__main {
  max-width: 1680px;
  margin: 0 auto;
  padding: 24px 16px 48px;
}

.public-sampling-result-detail-page__hero {
  margin-bottom: 24px;
  border-radius: 12px;
  padding: 24px 28px;
  color: #fff;
...
.public-sampling-result-detail-page__hero-bar {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 12px;
...
.public-sampling-result-detail-page__hero-back {
  border: none;
...
.public-sampling-result-detail-page__hero-back .material-symbols-outlined {
  font-size: var(--public-body-secondary);
}

.public-sampling-result-detail-page__status-pill {
  font-style: normal;
  display: inline-flex;
  align-items: center;
...
.public-sampling-result-detail-page__status-pill.is-normal {
  background: rgba(33, 156, 84, 0.22);
  color: #c8f5d8;
  border-color: rgba(255, 255, 255, 0.35);
}

.public-sampling-result-detail-page__status-pill.is-risk {
  background: rgba(186, 26, 26, 0.35);
  color: #ffe0e3;
  border-color: rgba(255, 255, 255, 0.4);
}

.public-sampling-result-detail-page__hero h1 {
  margin: 14px 0 8px;
  font-family: var(--font-display);
...
.public-sampling-result-detail-page__hero-en {
  margin: 0;
...
.public-sampling-result-detail-page__hero-sub {
  margin: 12px 0 0;
...
.public-sampling-result-detail-page__content {
  display: grid;
...
.public-sampling-result-detail-page__article-card,
.public-sampling-result-detail-page__side-card {
  border-radius: 12px;
...
.public-sampling-result-detail-page__meta-grid {
  display: grid;
...
.public-sampling-result-detail-page__meta-grid span {
  display: block;
...
.public-sampling-result-detail-page__meta-grid strong {
  margin-top: 4px;
  display: block;
...
.public-sampling-result-detail-page__block {
  margin-top: 20px;
}

.public-sampling-result-detail-page__block h3 {
  margin: 0 0 12px;
  font-size: var(--public-caption);
  font-weight: 800;
  letter-spacing: 0.08em;
...
.public-sampling-result-detail-page__field-grid {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 12px 16px;
}

.public-sampling-result-detail-page__field-grid > div {
  padding: 10px 0;
  border-bottom: 1px dashed rgba(195, 198, 211, 0.42);
}

.public-sampling-result-detail-page__field-grid span {
  display: block;
  font-size: var(--public-body-secondary);
  font-weight: 600;
  color: var(--on-surface-variant);
...
.public-sampling-result-detail-page__field-grid strong {
  font-size: var(--public-body);
  line-height: 1.55;
  font-weight: 600;
}

.public-sampling-result-detail-page__panel {
  margin-top: 18px;
  padding: 14px 16px;
  border-radius: 10px;
...
.public-sampling-result-detail-page__panel h3 {
  margin: 0 0 10px;
  display: flex;
  align-items: center;
  gap: 8px;
...
.public-sampling-result-detail-page__panel h3 .material-symbols-outlined {
  font-size: var(--public-body-em);
}

.public-sampling-result-detail-page__panel p {
  margin: 0;
...
.public-sampling-result-detail-page__panel.is-pass {
  background: rgba(33, 156, 84, 0.06);
  border-color: rgba(33, 156, 84, 0.22);
}

.public-sampling-result-detail-page__panel.is-risk {
  background: rgba(186, 26, 26, 0.06);
  border-color: rgba(186, 26, 26, 0.2);
}

.public-sampling-result-detail-page__panel.is-neutral {
  background: rgba(242, 244, 247, 0.85);
}

.public-sampling-result-detail-page__side {
  display: grid;
  gap: 12px;
  align-content: start;
}
...
.public-sampling-result-detail-page__side-card h3 {
  margin: 0 0 10px;
  color: var(--primary);
  font-size: var(--public-table-head-overline);
  letter-spacing: 0.08em;
...
.public-sampling-result-detail-page__side-card p {
  margin: 0;
  padding: 8px 0;
...
.public-sampling-result-detail-page__side-card p:last-of-type {
  border-bottom: none;
}

.public-sampling-result-detail-page__side-card p span {
  color: var(--on-surface-variant);
  font-size: var(--public-caption);
  flex-shrink: 0;
}

.public-sampling-result-detail-page__side-card p strong {
  color: var(--primary);
  font-size: var(--public-caption);
  text-align: right;
  font-weight: 700;
...
.public-sampling-result-detail-page__side-card button {
  width: 100%;
...
.public-sampling-result-detail-page__side-card button:last-child {
  margin-bottom: 0;
}
