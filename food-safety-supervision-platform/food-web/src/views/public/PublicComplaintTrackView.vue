...
.public-complaint-track-page__topbar-inner { max-width: 1680px; margin: 0 auto; min-height: 56px; padding: 0 16px; display: flex; align-items: center; justify-content: space-between; gap: 24px; }
.public-complaint-track-page__brand-nav { display: flex; align-items: center; gap: 24px; }
.public-complaint-track-page__brand { font-family: var(--font-display); font-size: 25px; font-weight: 800; color: var(--primary); }
.public-complaint-track-page__nav { display: flex; gap: 18px; }
.public-complaint-track-page__nav-item { border: none; background: transparent; min-height: 56px; color: var(--on-surface-variant); font-size: 12px; font-weight: 700; border-bottom: 2px solid transparent; cursor: pointer; }
...
.public-complaint-track-page__search-box { display: inline-flex; align-items: center; gap: 6px; border-radius: 8px; border: 1px solid rgba(195,198,211,.44); background: rgba(255,255,255,.75); padding: 0 12px; min-height: 34px; }
.public-complaint-track-page__search-box input { border: none; background: transparent; font-size: 12px; min-width: 220px; }
.public-complaint-track-page__icon-btn { width: 34px; height: 34px; border-radius: 8px; border: 1px solid transparent; background: transparent; color: var(--on-surface-variant); cursor: pointer; }
.public-complaint-track-page__logout { min-height: 34px; margin: 0; }
.public-complaint-track-page__main { max-width: 1680px; margin: 0 auto; padding: 24px 16px 48px; display: grid; gap: 14px; }
.public-complaint-track-page__head h1 { margin: 0 0 6px; color: var(--primary); font-family: var(--font-display); font-size: 40px; line-height: 1; }
.public-complaint-track-page__head p { margin: 0; font-size: 13px; color: var(--on-surface-variant); }
...
.public-complaint-track-page__stat-card span { font-size: 11px; color: var(--on-surface-variant); letter-spacing: .06em; text-transform: uppercase; }
.public-complaint-track-page__stat-card strong { font-size: 30px; color: var(--primary); line-height: 1; font-family: var(--font-display); }
...
.public-complaint-track-page__create-btn { border: none; border-radius: 10px; background: linear-gradient(135deg,#002660 0%,#003a8c 100%); color: #fff; display: grid; place-items: center; gap: 4px; font-size: 12px; font-weight: 700; cursor: pointer; padding: 10px; }
...
.public-complaint-track-page__filters span { font-size: 11px; color: var(--on-surface-variant); }
.public-complaint-track-page__filters select { min-height: 32px; border: 1px solid rgba(195,198,211,.6); border-radius: 7px; padding: 0 10px; font-size: 12px; background: #fff; }
.public-complaint-track-page__filter-actions { display: inline-flex; gap: 8px; }
.public-complaint-track-page__filter-actions button { min-height: 32px; border-radius: 7px; border: 1px solid transparent; background: var(--primary); color: #fff; font-size: 12px; font-weight: 700; padding: 0 12px; cursor: pointer; }
...
.public-complaint-track-page__item-meta span { font-size: 10px; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; color: var(--primary); background: rgba(70,89,231,.12); border-radius: 6px; padding: 2px 7px; }
.public-complaint-track-page__item-meta small { font-size: 11px; color: var(--on-surface-variant); }
.public-complaint-track-page__item h3 { margin: 10px 0 14px; font-size: 15px; color: var(--on-surface); line-height: 1.5; }
.public-complaint-track-page__item-status { display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; }
.public-complaint-track-page__item-status i { font-style: normal; font-size: 11px; font-weight: 700; min-height: 24px; padding: 0 8px; border-radius: 999px; border: 1px solid transparent; display: inline-flex; align-items: center; }
...
.public-complaint-track-page__item-status span { font-size: 11px; color: var(--on-surface-variant); font-weight: 700; }
...
.public-complaint-track-page__latest .material-symbols-outlined { font-size: 17px; color: var(--primary); margin-top: 1px; }
.public-complaint-track-page__latest strong { display: block; font-size: 11px; margin-bottom: 3px; }
.public-complaint-track-page__latest p { margin: 0; font-size: 11px; color: var(--on-surface-variant); line-height: 1.55; }
.public-complaint-track-page__item-side button { min-height: 32px; border-radius: 7px; border: 1px solid rgba(195,198,211,.58); background: #fff; color: var(--primary); font-size: 12px; font-weight: 700; cursor: pointer; }
.public-complaint-track-page__pager { border-top: 1px solid rgba(195,198,211,.4); padding-top: 10px; display: flex; justify-content: space-between; align-items: center; gap: 10px; color: var(--on-surface-variant); font-size: 12px; flex-wrap: wrap; }
.public-complaint-track-page__pager-actions { display: inline-flex; gap: 8px; }
.public-complaint-track-page__pager-actions .ghost { min-height: 30px; border-radius: 7px; border: 1px solid rgba(195,198,211,.58); background: #fff; color: var(--on-surface-variant); padding: 0 10px; font-size: 12px; cursor: pointer; }
...
.public-complaint-track-page__empty .material-symbols-outlined { font-size: 32px; color: #64749a; }
.public-complaint-track-page__empty h3 { margin: 0; font-size: 16px; color: var(--primary); }
.public-complaint-track-page__empty p { margin: 0; font-size: 12px; color: var(--on-surface-variant); }
.public-complaint-track-page__empty button { margin-top: 4px; min-height: 34px; border-radius: 7px; border: none; background: var(--primary); color: #fff; font-size: 12px; font-weight: 700; padding: 0 12px; cursor: pointer; }
...
@media (max-width: 760px) {
  ...
  .public-complaint-track-page__head h1 { font-size: 32px; }
