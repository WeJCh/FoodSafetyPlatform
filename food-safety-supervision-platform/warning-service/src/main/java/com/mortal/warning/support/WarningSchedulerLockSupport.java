...
@Service
public class WarningSchedulerLockSupport {

    private static final String SCENE = "warning-scheduler-lock";
    ...
    public WarningSchedulerLockSupport(ObjectProvider<RedissonClient> redissonClientProvider,
    ...
    public boolean executeWithLock(String schedulerName, long leaseSeconds, Runnable task) {
        ...
        try {
            locked = lock.tryLock(
                Math.max(0L, warningSchedulerLockProperties.getWaitSeconds()),
