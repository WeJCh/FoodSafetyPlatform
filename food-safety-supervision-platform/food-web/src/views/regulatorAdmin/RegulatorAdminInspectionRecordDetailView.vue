          ...
          <section class="hero-card">
            <div class="hero-card__head">
              <div>
                ...
                <p>{{ detail.record.problemDesc || defaultSummary }}</p>
              </div>
        ...
        <div class="content-grid">
          ...
          <aside class="side-stack">
            ...
            <section class="panel">
              <h4>流程提示</h4>
              <p class="plain-text">
                该页面用于区域管理员归档查看检查结果。若记录已触发整改，可继续联动整改复核页查看企业后续处理进度。
              </p>
            </section>
          </aside>
        </div>
...
function goBack() {
  router.push({ name: "regulator-admin-dispatch-records" }).catch(() => {});
}
...
.state-card { padding: 18px 20px; border: 1px solid #dbe3ee; background: #fff; color: #64748b; border-radius: 8px; }
.state-card--error { color: #b91c1c; border-color: #fecaca; background: #fef2f2; }
.topbar { display: flex; justify-content: space-between; gap: 12px; align-items: center; padding: 14px 18px; background: #f7f9fc; border: 1px solid #dbe3ee; border-radius: 10px; }
.topbar-main { display: flex; gap: 12px; align-items: center; }
.back-btn { width: 38px; height: 38px; border: 0; background: #e6e8eb; color: #002660; cursor: pointer; border-radius: 8px; }
...
.hero-card { position: relative; overflow: hidden; padding: 28px; background: linear-gradient(135deg, #002660, #003a8c); color: #fff; border-radius: 12px; }
.hero-card__head { display: flex; justify-content: space-between; gap: 12px; align-items: flex-start; }
.eyebrow { display: inline-block; padding: 4px 10px; background: rgba(255,255,255,0.12); color: rgba(255,255,255,0.82); font-size: 11px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; border-radius: 999px; }
...
.archive-card { display: grid; gap: 14px; padding: 20px; background: #fff; border: 1px solid #dbe3ee; border-radius: 12px; }
.archive-card h4,
...
.ghost,
.ghost--full { min-height: 36px; padding: 0 14px; border: 1px solid #cbd5e1; background: #fff; color: #334155; font-size: 12px; font-weight: 700; cursor: pointer; border-radius: 8px; }
.ghost--full { width: 100%; }
.info-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
.panel { padding: 20px; background: #fff; border: 1px solid #dbe3ee; border-radius: 12px; }
.panel-wide { min-height: 100%; }
.panel-head { display: flex; align-items: center; gap: 8px; margin-bottom: 16px; }
.bar { width: 4px; height: 18px; background: #002660; border-radius: 999px; }
...
.enterprise-icon { width: 52px; height: 52px; display: grid; place-items: center; background: #eef4ff; color: #002660; border-radius: 12px; }
...
.table-head__meta span { padding: 4px 8px; background: #f8fafc; border: 1px solid #dbe3ee; font-size: 11px; font-weight: 700; color: #475569; border-radius: 999px; }
...
.result-pill { display: inline-flex; min-height: 24px; align-items: center; justify-content: center; padding: 0 10px; border-radius: 999px; border: 1px solid transparent; font-size: 11px; font-weight: 800; }
...
.status-banner { padding: 10px 12px; border: 1px solid #dbe3ee; background: #f8fafc; color: #334155; border-radius: 8px; }
