...
-- ============================================
-- 1. 公众投诉记录
-- 监管人相关字段统一使用 regulation-service 的 food_regulator.id
-- ============================================
INSERT INTO complaint (
    id, complaint_no, complainant_name, contact, submitter_user_id, enterprise_id,
...
(4, 'COMP202403001', '市民张三', '13800000014', 14, 4, '服务态度差',
 ...
 1, '2024-03-01 14:00:00', 3, '2024-03-05 10:00:00',
...
(9, 'COMP202403003', '匿名', '13900000000', NULL, 1, '恶意投诉',
 ...
 3, 1, '2024-03-20 15:00:00', '2024-03-27 18:00:00',
 1, '2024-03-20 16:00:00', NULL, NULL,
 NULL, 1, '2024-03-21 10:00:00', '经核查，投诉内容与事实不符，且投诉人无法提供有效证据，联系方式无法核实，疑似恶意投诉。', 0),

-- 用于支撑投诉超量预警的补充投诉
(10, 'COMP202401002', '市民赵六', '13800000017', 14, 2, '水果腐坏',
 '在鲜果园购买的水果出现腐坏变质，怀疑商品保鲜管理不到位。',
 NULL,
 'FEEDBACKED', 'COMPLAINT', NULL,
 4, 2, '2024-01-28 14:00:00', '2024-02-04 18:00:00',
 2, '2024-01-28 11:00:00', 4, '2024-01-30 15:00:00',
 '经现场核查，店铺部分水果保鲜管理不到位，已要求立即清理问题商品并完善冷藏措施。',
 NULL, NULL, NULL, 0),

(11, 'COMP202402003', '市民钱七', '13800000018', 15, 2, '标签信息不清',
 '在鲜果园购买的预包装水果标签信息不完整，无法清晰识别产地和分装日期。',
 NULL,
 'FEEDBACKED', 'COMPLAINT', NULL,
 4, 2, '2024-02-14 16:00:00', '2024-02-21 18:00:00',
 2, '2024-02-14 10:00:00', 4, '2024-02-15 15:30:00',
 '经核查，企业标签张贴不规范，已责令立即整改并补充完整标签信息。',
 NULL, NULL, NULL, 0),

(12, 'COMP202403004', '市民孙八', '13800000019', 16, 5, '后厨卫生一般',
 '在香满楼餐厅就餐时发现部分餐具边缘有油渍，怀疑清洗消毒不到位。',
 NULL,
 'FEEDBACKED', 'COMPLAINT', NULL,
 6, 2, '2024-03-28 09:30:00', '2024-04-04 18:00:00',
 2, '2024-03-28 09:00:00', 6, '2024-03-30 16:00:00',
 '经检查发现餐具清洗流程执行不够严格，已要求企业立即整改并补充消毒记录。',
 NULL, NULL, NULL, 0),

(13, 'COMP202404004', '市民周九', '13800000020', 14, 5, '食材不够新鲜',
 '在香满楼餐厅就餐时感觉部分食材不够新鲜，希望监管部门核查。',
 NULL,
 'PENDING', 'COMPLAINT', NULL,
 NULL, NULL, NULL, '2024-04-24 18:00:00',
 2, '2024-04-17 11:00:00', NULL, NULL,
 NULL, NULL, NULL, NULL, 0);

-- ============================================
-- 2. 投诉处理记录
-- handler_id 同样统一使用 food_regulator.id
-- ============================================
INSERT INTO complaint_handle (complaint_id, handler_id, handle_result, handle_time, deleted)
VALUES
(1, 3, '1. 现场检查发现后厨管理存在漏洞；2. 责令企业加强从业人员培训；3. 企业已整改并向投诉人道歉；4. 投诉人表示满意。',
 '2024-01-25 16:00:00', 0),

(2, 4, '1. 检查进货记录和储存条件；2. 发现商品周转不及时；3. 要求企业加强质量管理；4. 企业已退款并道歉。',
 '2024-02-12 11:00:00', 0),

(3, 3, '1. 现场检查确认卫生状况不达标；2. 责令停业整改；3. 整改完成后通过复查；4. 已恢复营业。',
 '2024-02-14 15:00:00', 0),

(4, 3, '1. 与企业和投诉人沟通；2. 要求企业加强员工培训；3. 企业已道歉；4. 投诉人接受处理结果。',
 '2024-03-05 10:00:00', 0),

(5, 3, '1. 核查菜单和收费记录；2. 发现菜单未及时更新；3. 要求规范价格标示；4. 企业已退还差价。',
 '2024-03-14 16:00:00', 0),

(10, 4, '1. 现场抽查水果储存和冷柜温度；2. 发现部分商品保鲜措施不到位；3. 已要求及时清理问题水果并加强冷链管理。',
 '2024-01-30 15:00:00', 0),

(11, 4, '1. 核查预包装水果标签；2. 发现标签信息标注不完整；3. 已责令企业立即更换并规范后续标签管理。',
 '2024-02-15 15:30:00', 0),

(12, 6, '1. 检查后厨和餐具消毒流程；2. 发现部分清洗记录不完整；3. 已要求企业补齐记录并加强清洗消毒管理。',
 '2024-03-30 16:00:00', 0);
